...
class GenreIterator implements MusicIterator {
  ...
  constructor(songs: Song[], private genre: string) {
...
class ArtistIterator implements MusicIterator {
  ...
  constructor(songs: Song[], private artist: string) {
...
playlist.addSong({ title: "Ditto", artist: "NewJeans", genre: "Pop", durationSec: 185 });
playlist.addSong({ title: "Hype Boy", artist: "NewJeans", genre: "Pop", durationSec: 179 });
playlist.addSong({ title: "SPOT!", artist: "ZICO", genre: "Hip-Hop", durationSec: 195 });
playlist.addSong({ title: "Supernova", artist: "aespa", genre: "Pop", durationSec: 205 });
playlist.addSong({ title: "Drama", artist: "aespa", genre: "Pop", durationSec: 212 });
